...
* `docs/dataset/processed-dataset.md` — schema das colunas derivadas usadas pela RQ07.
* `docs/validation/rq01-rq02-validation.md`, `docs/validation/rq03-rq04-validation.md`,
  `docs/validation/rq05-rq06-validation.md` — manuais de validação das demais RQs, no mesmo padrão.
