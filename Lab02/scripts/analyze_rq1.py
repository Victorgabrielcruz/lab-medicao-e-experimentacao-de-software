#!/usr/bin/env python3
"""Executa a análise de RQ1 (tempo e conclusão) sobre o dataset validado."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--report", type=Path, default=ROOT / "reports/drafts/rq1-analysis.md")
    parser.add_argument("--figures", type=Path, default=ROOT / "reports/figures/rq1")
...
def main(argv: list[str]) -> int:
    ...
    print(f"RQ1: relatório em {args.report}, {len(figures)} figura(s) em {args.figures}.")
    return 0
